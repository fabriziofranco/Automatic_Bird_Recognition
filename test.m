...
aux_pava = [xx1,xx2,xx3,xx4,xx5];

sd_pava = std(aux_pava);


y11 = pava; % your mean vector;
x11 = pava;
for i = 1:10001
x11(i) = i;
end
...
aux_ramas = [xx6,xx7, xx8, xx9, xx10];


sd_ramas = std(aux_ramas);
...
figure
histogram(pava,15);
title('Histograma de periodograma (escalado) propedio normalizado de Pava con audios normalizados ')
figure
histogram(ramas,15);
title('Histograma de periodograma (escalado) propedio normalizado de Cortarramas con audios normalizados')
}%
